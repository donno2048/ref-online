async function main() {
    ...
    await pyodide.runPythonAsync('import micropip;await micropip.install("restricted-functions");import ref;__ref__(ref._ProtectFiles, ref._ProtectDirs, ref._LockPerms)')
    pyodide.runPython(`import js;from pyodide.console import _InteractiveConsole;js.pyconsole = _InteractiveConsole()`, pyodide.globals.get("dict")());
    async function lock(){
